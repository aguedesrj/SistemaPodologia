					...
					<div class="tab-pane" id="Informacoes">
						...
						<div class="row" style="margin-top: 20px;">
							...
							<div class="col-lg-3">
								...
								<s:textfield name="clienteVO.pacCalcadoUtiliza" id="pacCalcadoUtiliza" maxlength="100" theme="simple" cssStyle="width: 220px;" cssClass="form-control"/>
							</div>												
						</div>	
						<div class="row" style="margin-top: 20px;">
							<div class="col-lg-3">
								<s:label for="pacNumeroCalcado" cssClass="control-label">Número do calçado</s:label>
								<s:textfield name="clienteVO.pacNumeroCalcado" id="pacNumeroCalcado" maxlength="2" theme="simple" cssStyle="width: 80px;" cssClass="form-control"/>
							</div>
							<div class="col-lg-3">
								<s:label for="pacPeso" cssClass="control-label">Peso</s:label>
								<s:textfield name="clienteVO.pacPeso" id="pacPeso" maxlength="2" theme="simple" cssStyle="width: 80px;" cssClass="form-control"/>
							</div>	
							<div class="col-lg-3">
