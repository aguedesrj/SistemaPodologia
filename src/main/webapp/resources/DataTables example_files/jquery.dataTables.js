...
(/** @lends <global> */function( $ ) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input type="text" class="form-control" style="width: 200px;"/>') :
			  sSearchStr==="" ? '<input type="text" class="form-control" style="width: 200px;"/>' : sSearchStr+' <input type="text" class="form-control" style="width: 200px;"/>';
		...
		function _fnLanguageCompat( oLanguage )
		{
			...
			if ( !oLanguage.sEmptyTable && oLanguage.sZeroRecords &&
				oDefaults.sEmptyTable === "Nenhum registro encontrada na tabela" )
			{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "oLanguage": {
			 *          "sInfo": "Got a total of _TOTAL_ registros to show (_START_ to _END_)"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *      $('#example').dataTable( {
			 *        "oLanguage": {
			 *          "sInfoEmpty": "No registros to show"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(pesquisando no total de _MAX_ registros)",
			 ...
			 *    } );
			 */
			"sSearch": "Pesquisar dentro da tabela:",
